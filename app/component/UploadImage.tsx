...
export default function UploadImage({ files, setFiles }: ImageUploadType) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4 md:p-6">
      ...
      <motion.div
        ...
        initial={false}
        animate={{
          borderColor: isDragging ? "#ef4444" : "#ffffff10",
        ...
        className={clsx(
          ...
          isDragging && "ring-4 ring-red-400/30 border-red-500"
        )}
      >
        <div className="flex flex-col items-center gap-5">
          ...
          >
            <motion.div
              ...
              className="absolute -inset-4 bg-red-400/10 rounded-full blur-md"
            ...
            <UploadCloud
              className={clsx(
                ...
                isDragging
                  ? "text-red-500"
                  : "text-zinc-700 dark:text-zinc-300 group-hover:text-red-500 transition-colors duration-300"
              )}
            />
          </motion.div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-300 md:text-lg max-w-md mx-auto">
              {isDragging ? (
                <span className="font-medium bg-gradient-to-br from-red-600 to-red-800 bg-clip-text text-transparent">
                  Release to upload
                </span>
              ) : (
                <>
      ...
      <div className="mt-8">
        ...
        <div
          className={clsx(
            "flex gap-3 overflow-y-auto pr-2",
            files.length > 3 &&
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col gap-1 w-full">
                    <div className="flex items-center gap-2 min-w-0">
                      <FileIcon className="w-5 h-5 flex-shrink-0 text-red-500 dark:text-red-400" />
                      <h4
                  ...
                  <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full overflow-hidden mt-3">
                    <motion.div
                      ...
                      className={clsx(
                        ...
                        file.progress < 100 ? "bg-red-500" : "bg-emerald-500"
                      )}
                    />
                  </div>
                </div>
